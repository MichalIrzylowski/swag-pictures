...
function* registerFlow () {
  while (true) {
    ...
    try {
      ...
      yield put({type: ActionType.SET_CURRENT_USER, payload: registeredUserData});
...
function* removePictureFlow() {
  while (true) {
    ...
    try {
      ...
      yield put({type: ActionType.DELETE_PICTURE_SUCCESS, payload: removedPicture.id});
    } catch (e) {
...
function* searchUsersFlow() {
  while(true) {
    ...
    try {
      ...
      yield put({type: ActionType.SEARCH_FOR_USER_SUCCESS, payload: foundUsers})
    } catch (e) {
...
function* followUserFlow() {
  while(true) {
    ...
    try {
      ...
      yield put({type: ActionType.HANDLE_FOLLOW_SUCCESS, payload: succesfulyFollowedUser});
    } catch (e) {
