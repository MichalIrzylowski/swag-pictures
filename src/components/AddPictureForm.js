  ...
  render() {
    return(
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormGroup>
          <Label>Picture:</Label>
          <Input name='file' id='file' type='file' onChange={this.handleFilePick} />
        </FormGroup>
        <FormGroup>
          <Label>Title:</Label>
        ...
        <FormGroup>
          ...
          <Input name='description' id='description' type='text' onChange={this.handleChange} />
        </FormGroup>
...
function mapDispatchToProps(dispatch) {
  return {
    sendPictureData: (data, userId, config) => dispatch({type: ADD_PICTURE_REQUEST, payload: data, userId, config})
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(AddPictureForm);
